...
path = r'C:\Users\benja\OneDrive\Documents\python\MLB_Data\batting_1980.csv'
...
mydb = Database_Build(d_frame, host, username, password, database_name, table_name)

mydb = mydb.create_db(database_name)

cnct = cnct.connect_to_db(host, username, password, database_name)
